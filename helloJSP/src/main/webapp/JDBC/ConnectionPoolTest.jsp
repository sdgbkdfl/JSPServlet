...
<!-- 
	커넥션 풀(Connection Pool)
	    ...
	    Connection객체를 생성하는것은 네트워크 통신과 사용자 인증등 시간이 많이 소요되는 작업입니다.
	    빈번한 연결과 해제는 시스템 성능을 떨어 뜨릴수 있습니다.
	    
	    이를 해결하기 위해 커넥션풀이라는 공간에 커넥션객체를 미리 생성해 두고 
	    필요할때마다 요청하여 가져다 사용하는 방법입니다.
