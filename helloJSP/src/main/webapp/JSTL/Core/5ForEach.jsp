...
<h4>varStatus 속성</h4>
 <!-- 
	 ...
	 current :var에 지정한 현재 루프의 변수 값
	 index : var에 지정한 현재 루프의 변수 값
	 count : 실제 반복 횟수
	 first : 루프의 처음일때 true
	 last :루프의 마지막일때 true
  -->
...
<h5>향상된 for문 형태의 forEach 태그</h5>
	<%
		String[] rgba = {"red","green","blue","black"};
	%>
	<!-- 
	아이템 속성에 배열을 지정하고 변수이름은 'c'로 입력 
	배열을 처음부터 끝까지 돌면서 반복문 수행
	-->
	<table border="1">
